...
const MobDefinitions_js_1 = __importDefault(require("../consts/MobDefinitions.js"));
...
class SpawnZone {
    ...
    tick() {
        ...
        if (Math.random() < this.spawnTable.BASE_CHANCE) {
            ...
            if (this.arena.collisionGrid.getEntityCollisions(ent).length)
                return;
            this.arena.add(ent);
            ++this.mobCount;
        }
