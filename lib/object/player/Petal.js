...
class Petal extends Entity_1.default {
    constructor(arena, player, outerPos, innerPos, pos, rarity, petalDefinition) {
        ...
        this.pos.add(Vector_1.default.fromPolar(this.holdingRadius.pos, this.player.rotationAngle + this.rotationPos * Helpers_1.PI_2 / this.player.numSpacesAlloc));
    }
    tick() {
        ...
        if (this.followNormalRotation) {
            ...
            if (this.clump)
                this.accel.set2(Vector_1.default.fromPolar(this.holdingRadius.pos, this.player.rotationAngle + this.rotationPos * Helpers_1.PI_2 / this.player.numSpacesAlloc).add(Vector_1.default.fromPolar(10, this.innerPos * Helpers_1.PI_2 / this.count)).add(this.player.pos).sub(this.pos));
            else
