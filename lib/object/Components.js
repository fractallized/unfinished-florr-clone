...
exports.PetalComponent = exports.MobComponent = exports.PlayerInfoComponent = exports.DropComponent = exports.HealthComponent = exports.StyleComponent = exports.ArenaComponent = exports.CameraComponent = exports.PositionComponent = exports.Inventory = void 0;
...
class Inventory {
    constructor() {
        this.grandState = 2;
        this.values = new Int32Array(Helpers_js_1.RARITY_COUNT * 100);
...
class StyleComponent {
    constructor(entity, flags, opacity) {
        this.values = {
            flags, opacity
        };
        this.entity = entity;
    ...
    set flags(v) { if (this.values.flags === v)
        return; this.entity.state |= 1; this.state[0] |= 1; this.values.flags = v; }
