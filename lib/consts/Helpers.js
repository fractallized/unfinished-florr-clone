...
exports.minAngleDifference = exports.isWithin = exports.spliceOut = exports.FROM_OBJECT_TABLE = exports.FROM_TABLE = exports.PETAL_RARITY_MULTIPLIER = exports.MOB_SIZE_MULTIPLIER = exports.MOB_RARITY_MULTIPLIER = exports.LOOT_TABLE_GEN = exports.PI_2 = exports.RARITY_COUNT = void 0;
...
const minAngleDifference = (angle1, angle2) => {
    const first = Math.abs(angle1 - angle2) % exports.PI_2;
    const second = exports.PI_2 - (Math.abs(angle1 - angle2) % exports.PI_2);
